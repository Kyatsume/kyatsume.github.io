...
$.extend(CsvCalc.prototype, /** @lends CsvCalc.prototype */ {
  ...
  calcTotal: function () {
    var self = this;
    $(document.getElementsByClassName("totalMobs")).on('change', $(self.elem).find('[data-csvcalc-input]'), function (ev) {
      // バリデーションを行う
  ...
  calcTotal2: function () {
    var monster = this;
    $(document.getElementsByClassName("cMobs")).on('change', $(monster.elem).find('[data-csvcalc-mobsinput]'), function(ev) {
      // バリデーションを行う
